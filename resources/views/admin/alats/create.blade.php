    ...
    <div class="glass-card p-6">
        <div class="flex items-center justify-between">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-white">Tambah Alat</h1>
                    <p class="text-gray-400 text-sm">Tambah alat baru ke sistem</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <form method="POST" action="{{ route('admin.alats.store') }}" 
            ...
            <div>
                ...
                <textarea name="deskripsi" rows="4" 
                          ...
                          class="glass-input w-full px-4 py-3 rounded-lg text-white placeholder-gray-400">{{ old('deskripsi') }}</textarea>
                @error('deskripsi')
                    <p class="mt-2 text-sm text-red-400">{{ $message }}</p>
                @enderror
            </div>
